  ...
  return (
    <div className="min-h-screen pb-20 relative overflow-hidden" style={{ 
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <Star className="absolute top-20 left-10 w-6 h-6 text-white/40 animate-pulse" style={{ animationDelay: "0s" }} />
        <Sparkles className="absolute top-40 right-20 w-5 h-5 text-white/50 animate-pulse" style={{ animationDelay: "0.5s" }} />
        <Star className="absolute top-60 left-1/4 w-4 h-4 text-white/30 animate-pulse" style={{ animationDelay: "1s" }} />
        <Star className="absolute top-32 right-10 w-7 h-7 text-white/35 animate-pulse" style={{ animationDelay: "1.5s" }} />
        <Sparkles className="absolute top-80 left-1/3 w-6 h-6 text-white/40 animate-pulse" style={{ animationDelay: "2s" }} />
        <Star className="absolute top-96 right-1/4 w-5 h-5 text-white/45 animate-pulse" style={{ animationDelay: "2.5s" }} />
        <Sparkles className="absolute bottom-40 left-20 w-4 h-4 text-white/35 animate-pulse" style={{ animationDelay: "3s" }} />
        <Star className="absolute bottom-60 right-16 w-6 h-6 text-white/40 animate-pulse" style={{ animationDelay: "3.5s" }} />
      </div>
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-baseline gap-2 mb-1 whitespace-nowrap">
                      ...
                      <span className="text-sm text-muted-foreground">sur {TOTAL_LEADERBOARD_USERS} Pawters</span>
                    </div>
                    ...
                    return (
                      ...
                      >
                        <Card className={`transition-all ${
                          isCurrentUser ? "ring-2 ring-pink-500 bg-primary/10 shadow-md shadow-pink-500/50" : "hover:shadow-md"
