  ...
  return (
    <>
      ...
      <div className="flex flex-col h-screen overflow-hidden" style={{ background: "linear-gradient(135deg, #FFE4C4 0%, #FFD1E8 30%, #E6DBFF 100%)" }}>
        ...
        <div className="mx-auto max-w-2xl px-4 flex flex-col flex-1 pb-20">
          <div className="mb-1.5 shrink-0">
            <div className="flex items-center justify-between gap-2 mb-0.5">
              ...
              {/* Global counter */}
              <div className="bg-white/90 backdrop-blur-sm px-2.5 py-0.5 rounded-full shadow-lg">
                <div className="flex items-center gap-1">
                  <Users className="h-2.5 w-2.5 text-[#FF5DA2]" />
            ...
            <p className="text-[11px] text-muted-foreground">Swipe pour découvrir ton futur compagnon</p>
          </div>
          ...
          <div className="relative flex-1 min-h-0">
            ...
            >
              ...
              >
                <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2.5 py-0.5 rounded-full">
                  <p className="text-[10px] font-semibold" style={{ color: "var(--brand-raspberry)" }}>
                    {current.shelter}
                  </p>
                </div>
              </div>
              ...
              <div className="p-3">
                ...
                <p className="text-[11px] line-clamp-2" style={{ color: "var(--ink)", opacity: 0.8 }}>
                  {current.bio}
                </p>
              </div>
            </div>
          ...
          {/* Tags */}
          <div className="mt-1.5 mb-1.5 flex flex-wrap justify-center gap-1 shrink-0">
        ...
        {/* Actions */}
        <div className="flex justify-center items-center gap-2.5 mb-0.5 shrink-0">
          <Button
            size="lg"
            variant="outline"
          ...
          <Button
            ...
            disabled={!isPremium}
          >
            <Star className="h-5 w-5" style={{ color: isPremium ? "white" : "#9CA3AF" }} fill={isPremium ? "white" : "none"} />
          </Button>

          <Button
            size="lg"
            className="h-14 w-14 rounded-full shadow-soft bg-[#FF5DA2] hover:bg-[#FF5DA2]/90"
          ...
          {/* Progress */}
          <div className="text-center text-[11px] text-muted-foreground shrink-0">
