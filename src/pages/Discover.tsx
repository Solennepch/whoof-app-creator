  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-2xl px-4 flex flex-col flex-1 pb-20">
        <div className="mb-1.5 text-center shrink-0">
          <h1 className="mb-0.5 text-lg font-bold text-foreground">
            Découvrir
          </h1>
          <p className="text-[11px] text-muted-foreground">Swipe pour matcher avec de nouveaux amis</p>
        </div>
