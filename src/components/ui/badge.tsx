...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold transition-smooth focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default: "border-transparent gradient-signature text-white shadow-glow",
        secondary: "border-transparent bg-secondary text-secondary-foreground shadow-soft hover:opacity-90",
